...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `wireguardRef` _string_ | Reference to the wireguard resource |  | Required: \{\} <br /> |
| `address` _[Address](#address)_ |  | 192.168.254.2/24 | Pattern: `^((10(\.(([0-9]?[0-9])\|(1[0-9]?[0-9])\|(2[0-4]?[0-9])\|(25[0-5])))\{3\})\|(172\.((1[6-9])\|(2[0-9])(3[0-1]))(\.(([0-9]?[0-9])\|(1[0-9]?[0-9])\|(2[0-4]?[0-9])\|(25[0-5])))\{2\})\|(192\.168(\.(([0-9]?[0-9])\|(1[0-9]?[0-9])\|(2[0-4]?[0-9])\|(25[0-5])))\{2\})\|(127('\.(([0-9]?[0-9])\|(1[0-9]?[0-9])\|(2[0-4]?[0-9])\|(25[0-5])))\{3\}))/([8-9]\|(1[0-9])\|(2[0-9])\|(3[0-2]))$` <br /> |
